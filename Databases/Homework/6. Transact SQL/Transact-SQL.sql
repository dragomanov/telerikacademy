...
-- Task 3 --
-- Create a function that accepts as parameters Ц sum, yearly interest 
...
-- Task 6 --
-- Create another table Ц Logs(LogID, AccountID, OldSum, NewSum). 
...
-- Example 'oistmiahf' will return 'Sofia', 'Smith', Е but not 'Rob' and 'Guy'.
