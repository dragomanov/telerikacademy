...
namespace Methods
{
    class Methods
    {
        ...
        static int GetBiggestInteger(params int[] elements)
        {
            if (elements == null || elements.Length == 0)
            {
                throw new ArgumentNullException("elements", "Array can't be empty");
            }
        ...
        static void FormatNumber(object number, string format)
        {
            if (format == "f")
            {
        ...
        static void Main()
        {
            ...
            Console.WriteLine(GetBiggestInteger(5, -1, 3, 2, 14, 2, 3));
